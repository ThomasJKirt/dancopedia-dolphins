...
<section class="one">
    <div class="background">
        <div class="scrollContainer">
            <h1>Traditional Brazil Dances</h1>
...
<script src="../public/js/load_dances.js"></script>

<!-- Loads dances that are categorized as traditional -->
<script>
    document.addEventListener("DOMContentLoaded", function() {
        loadDances(null, "Traditional");
    });
</script>


document.addEventListener("click", function(e) {
const card = e.target.closest(".dance");
if (card) {
const danceId = card.getAttribute("data-dance-id");
window.location.href = `dancePage.php?danceId=${danceId}`;
}
});
</script>
</body>
